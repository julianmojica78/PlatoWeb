    ...
    <table class="auto-style27">
        ...
        <tr>
            ...
            <td class="auto-style30">
                <asp:TextBox ID="TB_Nombre" runat="server" Width="160px"></asp:TextBox>
            ...
            <td class="auto-style39">
                <asp:TextBox ID="TB_Apellido" runat="server" Width="161px"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style30">
                <asp:TextBox ID="TB_Usuario" runat="server" Width="160px"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style30">
                <asp:TextBox ID="TB_Contrasena" runat="server" Width="160px" TextMode="Password"></asp:TextBox>
            ...
            <td class="auto-style33">
                <asp:TextBox ID="TB_Cedula" runat="server" Width="160px"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style30">
                <asp:TextBox ID="TB_CConrasena" runat="server" Width="160px" TextMode="Password"></asp:TextBox>
            ...
            <td class="auto-style33">
                <asp:TextBox ID="TB_Celular" runat="server" Width="160px" Height="24px"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style44">
                <asp:DropDownList ID="DDL_Rol" runat="server" Height="26px" Width="213px">
        ...
        <tr>
            ...
            <td class="text-center" colspan="4" style="height: 26px">
                <asp:Button ID="B_Crear" runat="server" OnClick="B_Crear_Click" Text="Crear " />
            </td>
